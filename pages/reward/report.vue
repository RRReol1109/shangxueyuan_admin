<template>
  <div>
    <div class="search-form">
      <el-form :inline="true" :model="query">
        <!-- <el-form-item label="项目级别:">
          <el-select v-model="query.level" size="small">
        ...
        <el-form-item label="作者:">
          <el-input v-model="query.persons" placeholder="请输入作者" size="small"></el-input>
        </el-form-item>
        ...
        <el-form-item label="第一获奖人:">
          <el-input v-model="query.score" placeholder="请输入毕业专业"  size="small"></el-input>
        </el-form-item>-->
        <el-form-item label>
    ...
    <el-table :data="tableData" border style="width: 100%" v-loading="loading">
      ...
      <el-table-column prop="awardDate" align="center" label="发表时间"></el-table-column>
      <el-table-column prop="type" align="center" label="要报类型"></el-table-column>
      <el-table-column prop="resultName" align="center" label="成果名称"></el-table-column>
      <el-table-column prop="persons" align="center" label="作者及单位"></el-table-column>
      <el-table-column prop="score" align="center" label="获得分数"></el-table-column>
    ...
    async handleCommand(command) {
      ...
      switch (command) {
        ...
        case "delCount":
          ...
          break;
        case "temp":
          location.href = "http://bsoa.csu.edu.cn/excel-model/kyjl-hjyb.xls";
          break;
      }
    },
