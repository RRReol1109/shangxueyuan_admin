    ...
    <div class="search-form">
      <el-form :inline="true" :model="query">
        ...
        <el-form-item label="模拟类别" prop="type">
          <el-select v-model="query.type" size="small" placeholder="请选择模式">
            <el-option label="全部" value></el-option>
  ...
  methods: {
    ...
    async submitForm(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          this.ruleForm.weeks = parseInt(this.ruleForm.weeks);
    ...
    async exportData() {
      let data = await axios.$download("/simulation/export", {
        params: this.query
      });
      if (data) {
    ...
    async handleCommand(command) {
      ...
      switch (command) {
        ...
        case "delCount":
          ...
          break;
        case "temp":
          location.href = "http://112.74.56.60/excel/excel-model/gzl-spmn.xls";
          break;
      }
    },
