    ...
    <div class="search-form">
      <el-form :inline="true" :model="query">
        ...
        <el-form-item label="指导班级:">
          <el-input id="nameBox" v-model="query.classes" placeholder="请输入班级" size="small"></el-input>
        </el-form-item>
        <el-form-item label="备注:">
          <el-input id="nameBox" v-model="query.remark" placeholder="请输入班级" size="small"></el-input>
        </el-form-item>
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item>
                <el-upload
                  ...
                  action="http://bsart.zz.kuangyeyuan.com/survey/upload?token='AuthenticationToken'"
                >
    ...
    <el-dialog style="min-height:500px" title :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item label="指导班级" prop="classes">
          <el-col :span="12">
            <el-autocomplete v-model="ruleForm.classes" :fetch-suggestions="queryClasses"></el-autocomplete>
          </el-col>
        </el-form-item>
        <el-form-item label="备注" prop="remark">
          <el-col :span="12">
            <el-autocomplete v-model="ruleForm.remark" :fetch-suggestions="queryTopicArr"></el-autocomplete>
          </el-col>
        </el-form-item>
    ...
    async handleCommand(command) {
      ...
      switch (command) {
        ...
        case "delCount":
          ...
          break;
        case "temp":
          location.href = "http://112.74.56.60/excel/excel-model/gzl-shdc.xls";
          break;
      }
    },
