<template>
  <div>
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item>
                <el-upload
                  ...
                  action="http://bs.hk.darkal.cn/survey/upload?token='AuthenticationToken'"
                >
    ...
    >
      ...
      <el-table-column sortable :show-overflow-tooltip="true" prop="weeks" align="center" label="指导班级数"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    async exportData(flag) {
      let data = "";
      if (flag == "temp") {
        data = await axios.$download("/survey/export?id=-1", {});
      } else {
        data = await axios.$download("/survey/export", {
          params: this.query
        });
      }
      if (data) {
