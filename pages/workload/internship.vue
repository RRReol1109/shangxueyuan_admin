<template>
  <div>
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item>
                <el-upload
                  ...
                  action="http://bsart.zz.kuangyeyuan.com/internship/upload?token='AuthenticationToken'"
                >
    ...
    <el-dialog style="min-height:500px" title :visible.sync="dialogFormVisible" :disabled="read">
      <el-form
        :model="ruleForm"
        :rules="rules"
        ref="ruleForm"
    ...
    async handleCommand(command) {
      ...
      switch (command) {
        ...
        case "delCount":
          ...
          break;
        case "temp":
          location.href = "http://112.74.56.60/excel/excel-model/gzl-sx.xls";
          break;
      }
    },
    async list() {
