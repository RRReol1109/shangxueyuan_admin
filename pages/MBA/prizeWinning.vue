<template>
  <div>
    ...
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column prop="id" align="center" label="教师工号"></el-table-column>
      ...
      <el-table-column prop="student" align="center" label="序号"></el-table-column>
      <el-table-column prop="graduationStudent" align="center" label="获奖项目名称"></el-table-column>
      <el-table-column prop="admission" align="center" label="奖项类别"></el-table-column>
      <el-table-column prop="grant" align="center" label="奖励级别"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="颁奖机构"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="获奖证书编号"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="获奖年月"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="上传获奖证书PDF电子版"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="系数"></el-table-column>
