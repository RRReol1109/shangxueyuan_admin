<template>
  <div>
    ...
    <el-table :data="tableData" border style="width: 100%">
      <!-- <el-table-column sortable fixed prop="year" align="center" label="教职工工号"></el-table-column> -->
      ...
      <el-table-column sortable :show-overflow-tooltip="true" prop="college" align="center" label="所在系"></el-table-column>
      ...
      <el-table-column sortable :show-overflow-tooltip="true" prop="political" align="center" label="政治面貌"></el-table-column>
      <el-table-column sortable :show-overflow-tooltip="true" prop="idNum" align="center" label="身份证号码"></el-table-column>
      <el-table-column sortable :show-overflow-tooltip="true" prop="startDate" align="center" label="来院工作年月"></el-table-column>
      <el-table-column sortable :show-overflow-tooltip="true" prop="address" align="center" label="现住址"></el-table-column>
      ...
      <el-table-column sortable
        ...
        label="岗位"
      ></el-table-column>
      <el-table-column sortable :show-overflow-tooltip="true" prop="title" align="center" label="现职称"></el-table-column>
      <el-table-column sortable
        :show-overflow-tooltip="true"
        prop="titleDate"
        align="center"
        label="获得现职称年月"
      ></el-table-column>
      <el-table-column sortable :show-overflow-tooltip="true" prop="level" align="center" label="现职级"></el-table-column>
      <el-table-column sortable :show-overflow-tooltip="true" prop="tutor" align="center" label="导师资格"></el-table-column>
      <el-table-column sortable :show-overflow-tooltip="true" prop="personType" align="center" label="人才类别"></el-table-column>
      <el-table-column sortable :show-overflow-tooltip="true" prop="post" align="center" label="现职务"></el-table-column>
      <el-table-column sortable :show-overflow-tooltip="true" prop="postDate" align="center" label="任现职务年月"></el-table-column>
      <el-table-column sortable
        :show-overflow-tooltip="true"
        prop="highEducation"
        align="center"
        label="最高学历"
      ></el-table-column>
      <el-table-column sortable :show-overflow-tooltip="true" prop="highDegree" align="center" label="最高学位"></el-table-column>
      <el-table-column sortable :show-overflow-tooltip="true" prop="school" align="center" label="毕业学校"></el-table-column>
      <el-table-column sortable :show-overflow-tooltip="true" prop="college" align="center" label="毕业专业"></el-table-column>
      <el-table-column sortable :show-overflow-tooltip="true" prop="startDate" align="center" label="毕业年月"></el-table-column>
      ...
      <el-table-column sortable :show-overflow-tooltip="true" prop="homePhone" align="center" label="家庭电话"></el-table-column>
      <el-table-column sortable :show-overflow-tooltip="true" prop="email" align="center" label="电子邮箱"></el-table-column>
