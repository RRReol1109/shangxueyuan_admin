<template>
  <div>
    ...
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column prop="grant" align="center" label="学术会议名称"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="学术会议举办地点"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="学术会议组织者"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="会议年月"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="学术会议论文集名称"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="本人排名"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="院定级别"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="作者总数"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="论文他引次数"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="参会角色"></el-table-column>
