<template>
  <div>
    ...
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column prop="id" align="center" label="项目负责人工号"></el-table-column>
      <el-table-column prop="name" align="center" label="项目负责人姓名"></el-table-column>
      ...
      <el-table-column prop="graduationStudent" align="center" label="项目名称"></el-table-column>
      <el-table-column prop="admission" align="center" label="项目编号"></el-table-column>
      <el-table-column prop="grant" align="center" label="项目级别"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="合同经费(万元)"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="合同起止年月"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="进校经费额(万元)"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="教师工号"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="教师姓名"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="职称"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="分配经费(万元)"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="职称系数"></el-table-column>
