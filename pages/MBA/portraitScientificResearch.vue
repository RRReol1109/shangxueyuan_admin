<template>
  <div>
    ...
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column prop="student" align="center" label="项目名称"></el-table-column>
      <el-table-column prop="graduationStudent" align="center" label="项目编号"></el-table-column>
      <el-table-column prop="fullTime" align="center" label="项目来源"></el-table-column>
      <el-table-column prop="admission" align="center" label="立项机构"></el-table-column>
      <el-table-column prop="admissionRate" align="center" label="项目级别"></el-table-column>
      <el-table-column prop="grant" align="center" label="立项年月"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="起始年月日"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="终止年月日"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="合同经费(万元"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="上传批文"></el-table-column>
