  ...
  <div>
    ...
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column sortable
        ...
        label="项目级别"
      ></el-table-column>
      <el-table-column sortable :show-overflow-tooltip="true" prop="date" align="center" label="立项年月"></el-table-column>
      <el-table-column sortable :show-overflow-tooltip="true" prop="startDate" align="center" label="起始年月日"></el-table-column>
      <el-table-column sortable :show-overflow-tooltip="true" prop="endDate" align="center" label="终止年月日"></el-table-column>
      <el-table-column sortable :show-overflow-tooltip="true" prop="funds" align="center" label="合同经费(万元"></el-table-column>
      <el-table-column sortable :show-overflow-tooltip="true" prop="approvals" align="center" label="上传批文"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    async list() {
      ...
      let res = await axios.$post("/verticalResearch/list", this.query);
      if (res) {
    ...
    async examineData(flag) {
      ...
      for (let i = 0; i < examineList.length; i++) {
        ...
        await axios.$post("/verticalResearch/update", this.examineForm);
      }
      this.list();
    ...
    async submitForm(formName) {
      ...
      switch (this.operate) {
        case "add":
          await axios.$post("/verticalResearch/add", this.form);
          break;
        case "edit":
          await axios.$post("/verticalResearch/update", this.form);
          break;
      }
    ...
    async exportData(flag) {
      let data = "";
      if (flag == "temp") {
        data = await axios.$download("/verticalResearch/export?id=-1", {});
      } else {
        data = await axios.$download("/verticalResearch/export", {
          params: this.query
        });
      }
      if (data) {
      ...
      this.$confirm("此操作将永久删除该记录, 是否继续?", "提示", {
        ...
        .then(async () => {
          for (let i = 0; i < deleteList.length; i++) {
            ...
            await axios.$post("/verticalResearch/delete", {
