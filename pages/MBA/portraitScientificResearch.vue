            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item>
                <el-upload
                  ...
                  action="http://bsoa.csu.edu.cn/bs/verticalResearch/upload?token='AuthenticationToken'"
                >
    ...
    >
      ...
      >
        ...
        <el-form-item label="项目来源" prop="projectOrigin">
          <el-col :span="6">
            <el-input size="small" v-model="form.projectOrigin"></el-input>
          </el-col>
        </el-form-item>
        <el-form-item label="立项机构" prop="projectOrganizer">
          <el-col :span="6">
            <el-input size="small" v-model="form.projectOrganizer"></el-input>
          </el-col>
        </el-form-item>
        ...
        <el-form-item label="上传批文" prop="approvals">
          <el-col :span="6">
            <el-input size="small" v-model="form.approvals"></el-input>
          </el-col>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    async exportData() {
      let data = await axios.$download("/verticalResearch/export", {
        params: this.query
      });
      if (data) {
