<template>
  <div>
    ...
    <el-table :data="tableData" border style="width: 100%" height="600">
      ...
      <el-table-column sortable :show-overflow-tooltip="true" prop="projectId" align="center" label="合同编号"></el-table-column>
      ...
      <el-table-column sortable :show-overflow-tooltip="true" prop="pdfUrl" align="center" label="上传合同PDF文件"></el-table-column>
