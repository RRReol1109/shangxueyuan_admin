<template>
  <div>
    ...
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column prop="graduationStudent" align="center" label="合同编号"></el-table-column>
      <el-table-column prop="admission" align="center" label="立项单位"></el-table-column>
      ...
      <el-table-column prop="eliminate" align="center" label="上传合同PDF文件"></el-table-column>
