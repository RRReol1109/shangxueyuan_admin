<template>
  <div>
    ...
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column prop="id" align="center" label="主编工号"></el-table-column>
      <el-table-column prop="name" align="center" label="主编姓名"></el-table-column>
      <el-table-column prop="entrance" align="center" label="作者总数"></el-table-column>
      <el-table-column prop="student" align="center" label="全部作者列表"></el-table-column>
      <el-table-column prop="graduationStudent" align="center" label="题目"></el-table-column>
      <el-table-column prop="admission" align="center" label="类别(著作,教材)"></el-table-column>
      <el-table-column prop="grant" align="center" label="项目级别"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="出版社"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="ISBN号"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="总字数(万字)"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="本人撰写字数"></el-table-column>
      <el-table-column prop="eliminate" align="center" label="上传封面和版权页PDF电子版"></el-table-column>
    ...
    <el-dialog style="min-height:500px" :visible.sync="dialogFormVisible">
      <el-form :model="form" label-width="100px">
        ...
        <el-form-item label="作者总数">
          <el-col :span="6">
            <el-input size="small" v-model="form.count" autocomplete="off"></el-input>
          </el-col>
        </el-form-item>
        <el-form-item label="全部作者列表">
          <el-col :span="6">
