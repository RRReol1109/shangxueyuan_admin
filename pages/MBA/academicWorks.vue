<template>
  <div>
    ...
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column sortable :show-overflow-tooltip="true" prop="teacherId" align="center" label="主编工号"></el-table-column>
      <el-table-column sortable :show-overflow-tooltip="true" prop="name" align="center" label="主编姓名"></el-table-column>
      ...
      <el-table-column sortable :show-overflow-tooltip="true" prop="title" align="center" label="题目"></el-table-column>
      <el-table-column sortable :show-overflow-tooltip="true" prop="type" align="center" label="类别(著作,教材)"></el-table-column>
      <!-- <el-table-column sortable :show-overflow-tooltip="true" prop="level" align="center" label="项目级别"></el-table-column> -->
      <el-table-column sortable :show-overflow-tooltip="true" prop="publisher" align="center" label="出版社"></el-table-column>
      <el-table-column sortable :show-overflow-tooltip="true" prop="isbn" align="center" label="ISBN号"></el-table-column>
      <el-table-column sortable :show-overflow-tooltip="true" prop="wordCnt" align="center" label="总字数(万字)"></el-table-column>
      <el-table-column sortable :show-overflow-tooltip="true" prop="ownCnt" align="center" label="本人撰写字数"></el-table-column>
      <!-- <el-table-column sortable :show-overflow-tooltip="true" prop="pdfUrl" align="center" label="上传封面和版权页PDF电子版"></el-table-column> -->
