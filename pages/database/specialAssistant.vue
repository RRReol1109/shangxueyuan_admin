            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item>
                <el-upload
                  ...
                  action="http://bsoa.csu.edu.cn/bs/master/upload?token='AuthenticationToken'"
                >
    ...
    >
      ...
      >
        ...
        <el-form-item label="第一学历毕业学校" prop="education">
          <el-col :span="6">
            <el-input size="small" v-model="form.education" autocomplete="off"></el-input>
          </el-col>
        </el-form-item>
        ...
        <el-form-item label="专业代码" prop="majorCode">
          <el-col :span="6">
            <el-input size="small" v-model="form.majorCode" autocomplete="off"></el-input>
          </el-col>
        </el-form-item>
        ...
        <el-form-item label="录取方式" prop="admissionMethod">
          <el-col :span="6">
            <el-input size="small" v-model="form.admissionMethod" autocomplete="off"></el-input>
          </el-col>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    async handleCommand(command) {
      ...
      switch (command) {
        ...
        case "delCount":
          ...
          break;
        case "temp":
          location.href = "http://112.74.56.60/excel/excel-model/sjk-zsmd.xls";
          break;
        case "download":
          this.exportData();
          break;
    ...
    async exportData() {
      let data = await axios.$download("/master/export", {
        params: this.query
      });
      if (data) {
