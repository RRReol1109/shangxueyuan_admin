  ...
  <div>
    <div class="search-form">
      <el-form :inline="true" :model="query">
        ...
        <el-form-item label v-if="deptid==35||roleId==1">
          <el-button
            size="normal"
            type="primary"
            icon="el-icon-plus"
        ...
        <el-form-item v-if="deptid==35||roleId==1">
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item>
                <el-upload
                  ...
                  action="http://bs.hk.darkal.cn/educationalReform/upload?token='AuthenticationToken'"
                >
...
export default {
  ...
  methods: {
    ...
    async exportData(flag) {
      let data = "";
      if (flag == "temp") {
        data = await axios.$download("/educationalReform/export?id=-1", {});
      } else {
        data = await axios.$download("/educationalReform/export", {
          params: this.query
        });
      }
      if (data) {
        ...
        link.href = url;
        link.setAttribute("download", "数据库-教师教改项目.xls");
