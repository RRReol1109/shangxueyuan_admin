            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item>
                <el-upload
                  ...
                  action="http://bsoa.csu.edu.cn/bs/subjectInfo/upload?token='AuthenticationToken'"
                >
...
export default {
  ...
  methods: {
    ...
    async handleCommand(command) {
      ...
      switch (command) {
        ...
        case "delCount":
          ...
          break;
        case "temp":
          location.href = "http://112.74.56.60/excel/excel-model/sjk-xkjs.xls";
          break;
        case "download":
          this.exportData();
          break;
    ...
    async exportData() {
      let data = await axios.$download("/subjectInfo/export", {
        params: this.query
      });
      if (data) {
