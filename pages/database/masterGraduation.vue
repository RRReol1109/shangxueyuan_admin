  ...
  <div>
    <div class="search-form">
      <el-form :inline="true" :model="query">
        ...
        <el-form-item label="导师:">
          <el-input v-model="query.teacher" placeholder="请输入姓名" size="small"></el-input>
        </el-form-item>
        <el-form-item label="专业:">
          <el-input v-model="query.category" placeholder="请输入专业" size="small"></el-input>
        </el-form-item>
        <el-form-item label>
          <el-button size="small" type="primary" icon="el-icon-search" @click="list">查询</el-button>
        </el-form-item>
        <el-form-item label v-if="deptid==25||roleId==1||deptid==37">
          <el-button
            size="small"
            type="primary"
            icon="el-icon-plus"
        ...
        <el-form-item v-if="deptid==25||roleId==1||deptid==37">
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item>
                <el-upload
                  ...
                  action="http://bsoa.csu.edu.cn/bs/masterGraduate/upload?token='AuthenticationToken'"
                >
    ...
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column
        ...
        label="操作"
        width="150"
        v-if="deptid==25||roleId==1||deptid==37"
      >
        <template slot-scope="scope">
    ...
    >
      ...
      >
        ...
        <el-form-item label="在读期间发表论文" label-width="320px" prop="name">
          <el-col :span="6">
            <el-input size="small" v-model="form.paper" autocomplete="off"></el-input>
          </el-col>
        </el-form-item>
  ...
  methods: {
    ...
    async handleCommand(command) {
      ...
      switch (command) {
        ...
        case "delCount":
          ...
          break;
        case "temp":
          location.href = "http://112.74.56.60/excel/excel-model/skj-xsby.xls";
          break;
        case "download":
          this.exportData();
          break;
    ...
    async exportData() {
      ...
      if (data) {
        ...
        link.href = url;
        link.setAttribute("download", "skj-xsby.xls");
