            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item>
                <el-upload
                  ...
                  action="http://bsoa.csu.edu.cn/bs/event/upload?token='AuthenticationToken'"
                >
...
export default {
  ...
  methods: {
    ...
    async handleCommand(command) {
      ...
      switch (command) {
        ...
        case "delCount":
          ...
          break;
        case "temp":
          location.href = "http://112.74.56.60/excel/excel-model/sjk-hdgh.xls";
          break;
    ...
    async exportData() {
      let data = await axios.$download("/event/export", {
        params: this.query
      });
      if (data) {
        ...
        link.href = url;
        link.setAttribute("download", "sjk-hdgh.xls");
