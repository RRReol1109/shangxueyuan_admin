<template>
  <div>
    ...
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column sortable :show-overflow-tooltip="true" prop="subject" align="center" label="所属学科"></el-table-column>
      <el-table-column sortable :show-overflow-tooltip="true" prop="gender" align="center" label="性别"></el-table-column>
      <el-table-column sortable :show-overflow-tooltip="true" prop="birthplace" align="center" label="生源地"></el-table-column>
      <el-table-column sortable :show-overflow-tooltip="true" prop="nationality" align="center" label="民族"></el-table-column>
      <el-table-column sortable
        :show-overflow-tooltip="true"
        ...
        label="政治面貌"
      ></el-table-column>
      <el-table-column sortable :show-overflow-tooltip="true" prop="birthDate" align="center" label="出生年月"></el-table-column>
      <el-table-column sortable
        width="150"
        :show-overflow-tooltip="true"
        prop="auditFlag"
    ...
    async exportData(flag) {
      ...
      if (flag == "temp") {
        data = await axios.$download(
          "/undergraduateSubjectInformation/export?id=-1",
          {}
        );
      } else {
        data = await axios.$download(
          "/undergraduateSubjectInformation/export",
          {
            params: this.query
          }
        );
      ...
      if (data) {
        ...
        link.href = url;
        link.setAttribute("download", "数据库-学生学科信息.xls");
