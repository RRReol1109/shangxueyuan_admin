<template>
  <div>
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item>
                <el-upload
                  ...
                  action="http://bsoa.csu.edu.cn/bs/postgraduate/upload?token='AuthenticationToken'"
                >
    ...
    <el-table :data="tableData" border style="width: 100%" v-loading="loading">
      ...
      <el-table-column prop="year" align="center" label="论文编号"></el-table-column>
      <el-table-column prop="userName" align="center" label="入藏号"></el-table-column>
      <el-table-column prop="type" align="center" label="论文标题"></el-table-column>
      <el-table-column prop="count" align="center" label="作者"></el-table-column>
      <el-table-column prop="graduationCount" align="center" label="我院老师姓名"></el-table-column>
      <el-table-column prop="studentName" align="center" label="期刊"></el-table-column>
      <!-- <el-table-column prop="hours" align="center" label="实际课时数"></el-table-column> -->
      <el-table-column prop="editorName" align="center" label="ESI学科"></el-table-column>
      <el-table-column prop="editorName" align="center" label="地址"></el-table-column>
      <el-table-column prop="editorName" align="center" label="机构"></el-table-column>
      <el-table-column prop="editorName" align="center" label="发表年度"></el-table-column>
      <el-table-column prop="editorName" align="center" label="首次记录时间"></el-table-column>
      <el-table-column prop="editorName" align="center" label="奖励类型"></el-table-column>
      <el-table-column prop="editorName" align="center" label="科研部奖励批次"></el-table-column>
      <el-table-column prop="editorName" align="center" label="被引级"></el-table-column>
      <el-table-column prop="editorName" align="center" label="年份"></el-table-column>
    ...
    async handleCommand(command) {
      ...
      switch (command) {
        ...
        case "delCount":
          ...
          break;
        case "temp":
          location.href = "http://112.74.56.60/excel/excel-model/gzl-yjszd.xls";
          break;
      }
    },
