<template>
  <div>
    <div class="search-form">
      <el-form :inline="true" :model="query">
        ...
        <el-form-item label="学科">
          <el-select v-model="query.major" size="normal" placeholder="请选择">
            <el-option label="全部" value></el-option>
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item>
                <el-upload
                  ...
                  action="http://bs.hk.darkal.cn/threeDisciplinaryStaff/upload?token='AuthenticationToken'"
                >
    ...
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column sortable :show-overflow-tooltip="true" prop="major" align="center" label="学科"></el-table-column>
    ...
    >
      ...
      >
        ...
        <el-form-item label="学科" prop="major">
          <el-select v-model="form.major" size="normal" placeholder="请选择" style="width:99%">
            <el-option label="管理" value="管理"></el-option>
            <el-option label="工商" value="工商"></el-option>
            <el-option label="应经" value="应经"></el-option>
          </el-select>
...
export default {
  ...
  methods: {
    ...
    async list() {
      ...
      let res = await axios.$post("/threeDisciplinaryStaff/list", this.query);
    ...
    async submitForm(formName) {
      ...
      switch (this.operate) {
        case "add":
          ...
          break;
        case "edit":
          await axios.$post("/threeDisciplinaryStaff/update", this.form);
          break;
      }
    ...
    async del(row) {
      this.$confirm("此操作将永久删除该记录, 是否继续?", "提示", {
        ...
        .then(async () => {
          console.log(row);
          let threeDisciplinaryStaffId = row.id;
          await axios.$post("/threeDisciplinaryStaff/delete", {
            threeDisciplinaryStaffId: threeDisciplinaryStaffId
          });
          this.list();
          this.$message({
            type: "success",
    ...
    async examineData(flag) {
      ...
      for (let i = 0; i < examineList.length; i++) {
        ...
        await axios.$post("/threeDisciplinaryStaff/update", this.examineForm);
      }
      this.list();
    ...
    async exportData(flag) {
      ...
      if (flag == "temp") {
        data = await axios.$download(
          "/threeDisciplinaryStaff/export?id=-1",
          {}
        );
      } else {
      ...
      this.$confirm("此操作将永久删除该记录, 是否继续?", "提示", {
        ...
        .then(async () => {
          for (let i = 0; i < deleteList.length; i++) {
            ...
            let threeDisciplinaryStaffId = element.id;
            await axios.$post("/threeDisciplinaryStaff/delete", {
              threeDisciplinaryStaffId: threeDisciplinaryStaffId
            });
          }
