<template>
  <div>
    ...
    <el-table :data="tableData" v-loading="loading" border style="width: 100%">
      ...
      <el-table-column prop="level" align="center" label="项目级别" width="100"></el-table-column>
      <el-table-column prop="type" align="center" label="项目类型" min-width="100"></el-table-column>
      <el-table-column prop="score" align="center" label="基础计分" width="100"></el-table-column>
      <el-table-column prop="national" align="center" label="重点项目加分" min-width="50"></el-table-column>
      <el-table-column prop="province" align="center" label="重大项目加分" min-width="50"></el-table-column>
